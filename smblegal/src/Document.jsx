    ...
    return (
      <div class='internship'>
        ...
        <div id='container'>
          <ol class='info'>
            <li>
              Internship Description. [JOB RESPONSIBILITIES]
              <ol class='details'>
                <li>
                  <span class='word'>Educational Environment.</span> This internship is for the educational benefit of <span class='fill'>{values.internName}</span>. {creditRequire} <span class='fill'>{values.internName}</span> will be the primary beneficiary of this internship.
                </li>
                <li>
                  <span class='word'>No Expectation of Employment.</span> By signing this agreement <span class='fill'>{values.internName}</span> acknowledges and
                  agrees that this internship is for a fixed duration and comes with no promises or
                  expectations of employment beyond the internship.
                </li>
              </ol>
            </li>
            <br />
            <li>
              Directives, Policies and Procedures. Employment is conditioned upon continued adherence to the directives, policies and procedures of the Company.
              ...
              employee training manual.  These policies and procedures may be modified at any time.
            </li>
            <br />
            <li>
              Employment Eligibility Verification. This offer of employment is contingent upon you showing documentation showing your
              right to work in the United States within three (3) days of being hired.  This offer may be revoked, and you will not be
              allowed to work for the Company, if this documentation is not provided within three (3) days.
            </li>
            <br />
            <li>
              {stateRequire}
            ...
            <br />
            <li>
              Background and Reference Check.  The Company has the right to, if they so choose, check the
              education and professional background of its prospective or actual employees.
            </li>
            <br />
            <li>
              {expensesRequire}
            ...
            <br />
            <li>
              No Breach. <span class='fill'>{values.internName}</span> by signing this agreement, represents and warrants to Company that by
            ...
            their former employee and will not use such information at the Company.
            </li>
            <br />
            <li>
              At-Will Internship. All interns are “employees at will”.  This means that an intern may terminate
              internship at any time, for any reason.  The Company may also terminate the intern,
              with or without cause, for any reason.
            </li>
            <br />
            <li>
              Confidentiality, Non-Solicitation and Return of Property. As a condition of employment <span class='fill'>{values.internName}</span> must refrain from using or disclosing trade-secrets or confidential information of the Company or
             ...
             its clients. After the employment relationship between <span class='fill'>{values.internName}</span> and the Company has ended, <span class='fill'>{values.internName}</span> agrees that trade secrets will not be used to solicit any clients or employees of the Company.
             All Company trade secrets and confidential information will be returned upon the termination of the
            ...
            <br />
            <li>
              Invention Assignment. All ideas, inventions, improvements, methods, processes,
            ...
            <li>
              ...
              <ol class='details'>
                <li>
                  <span class='word'>INTEGRATION.</span>  This offer letter contains the entire understanding between the Company
                ...
                <li>
                  <span class='word'>GOVERNING LAW.</span> The validity, interpretation, construction and performance of this offer
                ...
                <li>
                  <span class='word'>ASSIGNMENT, SUCCESSORS AND ASSIGNS.</span>The rights bestowed upon <span class='fill'>{values.internName}</span> in this agreement are personal
                ...
                <li>
                  <span class='word'>SEVERABILITY.</span> If one or more provisions of this agreement are deemed void or
                ...
                <li>
                  <span class='word'>COUNTERPARTS.</span> This agreement may be executed in counterparts each of
