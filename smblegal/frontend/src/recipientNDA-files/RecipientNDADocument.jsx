  ...
  render() {
    ...
    return (
      <div class='size' >
        ...
        <p>Subject to permitted disclosures in clause 4 and 5 the Parties agree that this
        ...
        <h7 class='indoc'>3. Definition of Confidential Information. </h7>
        ...
        <h7 class='indoc'>4. Use of Confidential Information. </h7>
        ...
        <h7 class='indoc'>6. Destruction and Return. </h7>
        <p>Upon termination of the relationship between the
        ...
        <h7 class='indoc'>7. Indemnification. </h7>
        <p>Both Parties shall indemnify and hold harmless the other Party
        ...
        <h7 class='indoc'>8. No Licenses, No Transfer of Rights or Interest. </h7>
        ...
        <h7 class='indoc'>9. Survival. </h7>
        <p>his Agreement shall govern all communications between the Parties. The
